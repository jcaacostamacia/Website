...
- [BatchPhoto](https://www.batchphoto.com/features.html): This app allows you to edit large quantities of photos that you want to modify in the exact same way. For example, if you need to crop the exact same area or increase the contrast of hundreds of pictures, this app allows to do it in just a few simple steps.  
